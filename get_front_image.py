...
FRONT_CAMERA_IDS = ["front_1", "front_2", "front_3", "front_4"]
CAPTURE_DIR = Path("captures/front")
...
class FrontImageCollector:
    ...
    def open_cameras(self) -> None:
        for camera_id in FRONT_CAMERA_IDS:
            camera = FRONT_CAMERAS[camera_id]
    ...
    def save_capture(self, frame: np.ndarray) -> Path:
        ...
        output_path = CAPTURE_DIR / f"front_{timestamp}.jpg"
    ...
    def run(self) -> None:
        ...
        try:
            while True:
                ...
                cv2.imshow("Front Camera Collector", merged_frame)
...
if __name__ == "__main__":
    FrontImageCollector().run()
    
# python3 get_rear_image.py
