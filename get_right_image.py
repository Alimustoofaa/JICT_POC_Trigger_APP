...
RIGHT_CAMERA_IDS = ["right_2", "right_1"]
CAPTURE_DIR = Path("captures/right")
...
class RightImageCollector:
    def __init__(self) -> None:
        self.streams: dict[str, FFmpegRTSPCamera] = {}

    def open_cameras(self) -> None:
        for camera_id in RIGHT_CAMERA_IDS:
            camera = RIGHT_CAMERAS[camera_id]
    ...
    def save_capture(self, frame: np.ndarray) -> Path:
        ...
        output_path = CAPTURE_DIR / f"right_{timestamp}.jpg"
    ...
    def run(self) -> None:
        ...
        try:
            while True:
                ...
                cv2.imshow("Right Camera Collector", merged_frame)
